...
ADCSampler::ADCSampler(void) //can change the names of the pins here or in MatLab 
//edit end of logreader to change variables to better names
//in MatLab call logreader in separate file --> then assign pins to new variables. separate script. 
